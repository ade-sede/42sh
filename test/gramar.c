...
static struct s_static_grammar_rule rules[NB_RULES] = {
	...
	{symb_in, {TK_IN}},
	{for_clause, {TK_FOR, name, linebreak, symb_in, sequential_sep, do_group}},
	{for_clause, {TK_FOR, name, linebreak, symb_in, wordlist, sequential_sep, do_group}},
	{name, {TK_NAME}},
	{wordlist, {wordlist, TK_WORD}},
	{wordlist, {TK_WORD}},
	{case_clause, {TK_CASE, TK_WORD, linebreak, symb_in, linebreak, case_list, TK_ESAC}},
	{case_clause, {TK_CASE, TK_WORD, linebreak, symb_in, linebreak, case_list_ns, TK_ESAC}},
	{case_clause, {TK_CASE, TK_WORD, linebreak, symb_in, linebreak, TK_ESAC}},
